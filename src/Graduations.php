<html>
	...
	<body>
		...
		<?php echo "
		<center> <h1>Graduations</h1></center><br>
	<p class = 'p'>Tossing your hats high up in the air is almost like a tradition
	of graduates. But graduating is more than just throwing your hats in the air, or dressing up, or even 
	receiving an important piece of paper. Graduation is about celebrating achievements, being with the 
	people you shared a part of your life with, and being proud of your journey.</p><br>
	
	<table width = '100%'>
	<tr>
		<td><center><img src ='images/Graduation/1.jpg' width ='80%' , alt='william bday' ></td></center>
		<td><center><img src ='images/Graduation/2.jpg' width ='80%' , alt='adam and eve wedding' ><br><br></td></center>
		<td><center><img src ='images/Graduation/3.jpg' width ='80%' , alt='graduation' ></td></center>
	</tr>
	<tr>
		<td><center><img src ='images/Graduation/4.jpg' width ='80%' , alt='fashion show' ></td></center>
		<td><center><img src ='images/Graduation/5.jpg' width ='80%' , alt='music feast' ></td></center>
		<td><center><img src ='images/Graduation/6.jpg' width ='80%' , alt='religious event' ></td></center>
	</tr>
	<tr>
		<td><center><img src ='images/Graduation/7.jpg' width ='80%' , alt='fashion show' ></td></center>
		<td><center><img src ='images/Graduation/8.jpg' width ='80%' , alt='music feast' ></td></center>
		<td><center><img src ='images/Graduation/9.jpg' width ='80%' , alt='religious event' ><br><br></td></center>
	</tr></div></table></div> 
	"?>
