<html>
	...
	<div style ='margin: 20px 50px 100px 50px;'>	
		<?php
	echo "
		<center> <h1>Birthday Parties</h1></center><br>
	<p class = 'p'>Your age is more than simply a piece of personal data. 
	It's a testament to how much you've gotten out of life and how much more there 
	remains to discover. When photographing a birthday party, you're attempting to 
	capture the essence of the occasion. Every accomplishment is a small win on the 
	way to reaching your objectives. Take a peek at some of the birthday celebrations 
	we've documented.</p><br>
	
		<table width = '100%'>
	<tr>
		<td><center><img src ='images/Birthday party/1.jpg' width ='80%' , alt='william bday' ></td></center>
		<td><center><img src ='images/Birthday party/2.jpg' width ='80%' , alt='adam and eve wedding' ></td></center>
		<td><br><center><img src ='images/Birthday party/3.jpg' width ='80%' , alt='graduation' ></td></center>
	</tr>
	<tr>
		<td><center><img src ='images/Birthday party/4.jpg' width ='80%' , alt='fashion show' ></td></center>
		<td><center><img src ='images/Birthday party/5.jpg' width ='80%' , alt='music feast' ></td></center>
		<td><center><img src ='images/Birthday party/6.jpg' width ='80%' , alt='religious event' ></td></center>
	</tr>
	<tr>
		<td><br><center><img src ='images/Birthday party/7.jpg' width ='80%' , alt='fashion show' ></td></center>
		<td><center><img src ='images/Birthday party/8.jpg' width ='80%' , alt='music feast' ></td></center>
		<td><center><img src ='images/Birthday party/9.jpg' width ='80%' , alt='music feast' ><br><br></td></center>
	</tr>
	</div></table></div>
	"?>
