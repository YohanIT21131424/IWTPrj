<html>
	...
	<?php echo "	
		<center> <h1>Family Photos</h1></center><br>
	<p class = 'p'>Family photos help us connect with those who have gone before us. 
	Allowing your children to see images from the past and present connects them to 
	their own stories. They are familiar with the relatives and ancestors who came 
	before them and shaped the world and people they see today. Because, as time 
	passes, it is the memories of loved ones that we will treasure most. Words can't 
	express the feelings that family photos can.</p><br>
	
	
	<table width = '100%'>
	<tr>
		<td><center><img src ='images/Family/1.jpg' width ='80%' , alt='william bday' ></td></center>
		<td><center><img src ='images/Family/2.jpg' width ='80%' , alt='adam and eve wedding' ><br><br></td></center>
		<td><center><img src ='images/Family/3.jpg' width ='80%' , alt='graduation' ></td></center>
	</tr>
	<tr>
		<td><center><img src ='images/Family/4.jpg' width ='80%' , alt='fashion show' ></td></center>
		<td><center><img src ='images/Family/5.jpg' width ='80%' , alt='music feast' ><br><br></td></center>
		<td><center><img src ='images/Family/6.jpg' width ='80%' , alt='religious event' ></td></center>
	</tr>
	<tr>
		<td><center><img src ='images/Family/7.jpg' width ='80%' , alt='fashion show' ></td></center>
		<td><center><img src ='images/Family/8.jpg' width ='60%' , alt='music feast' ><br><br></td></center>
		<td><center><img src ='images/Family/9.jpg' width ='80%' , alt='religious event' ></td></center>
	</tr></div></table></div>
	"?>
