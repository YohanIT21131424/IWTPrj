<html>
	...
	<?php echo "	
		<center> <h1>Weddings</h1></center><br>
	<p class = 'p'>Wedding photographs are crucial since they are the most effective way to preserve your wedding memories. 
		It's not just about shoes and cake, but also about people and feelings. These are concrete proof of how wonderful 
		your wedding day was and how delighted your family and friends were. They're the things that will make you laugh 
		and cry long after the final light in your reception area has gone out.</p><br>
	
	<table width = '100%'>
	<tr>
		<td><center><img src ='images/Wedding/1.jpg' width ='80%' , alt='william bday' ></td></center>
		<td><center><img src ='images/Wedding/2.jpg' width ='80%' , alt='adam and eve wedding' ></td></center>
		<td><center><img src ='images/Wedding/3.jpg' width ='80%' , alt='graduation' ></td></center>
	</tr>
	<tr>
		<td><center><img src ='images/Wedding/4.jpg' width ='80%' , alt='fashion show' ></td></center>
		<td><center><img src ='images/Wedding/5.jpg' width ='80%' , alt='music feast' ></td></center>
		<td><center><img src ='images/Wedding/6.jpg' width ='80%' , alt='religious event' ></td></center>
	</tr>
	<tr>
		<td><center><img src ='images/Wedding/7.jpg' width ='80%' , alt='fashion show' ></td></center>
		<td><center><img src ='images/Wedding/8.jpg' width ='80%' , alt='music feast' ></td></center>
		<td><center><img src ='images/Wedding/9.jpg' width ='80%' , alt='religious event'></td></center>
	</tr></div></table></div>
	" ?>
