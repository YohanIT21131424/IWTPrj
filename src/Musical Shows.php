<html>
	...
	<div style ='margin: 20px 50px 100px 50px;'>
		...
		<center> <h1>Musical Shows</h1></center><br>
	<p class = 'p'>It is almost mandatory for every musician to have photographs taken of them 
	throughout their performances. It's a sort of marketing. Those images are what 
	entice people to attend a show just because it "looks" entertaining or epic. 
	Concert photography is an art form in itself. A means of self-expression. 
	But it's also something that makes other people feel. It has an impact on other 
	people's life.</p><br>
	
		<table width = "100%">
	<tr>
		<td><center><img src ="images/Musical shows/1.jpg" width ="80%" , alt="william bday" ></td></center>
		<td><center><img src ="images/Musical shows/2.jpg" width ="80%" , alt="adam and eve wedding" ></td></center>
		<td><center><img src ="images/Musical shows/3.jpg" width ="80%" , alt="graduation" ></td></center>
	</tr>
	<tr>
		<td><center><img src ="images/Musical shows/4.jpg" width ="80%" , alt="fashion show" ></td></center>
		<td><center><img src ="images/Musical shows/5.jpg" width ="80%" , alt="music feast" ></td></center>
		<td><center><img src ="images/Musical shows/6.jpg" width ="80%" , alt="religious event" ></td></center>
	</tr>
	<tr>
		<td><center><img src ="images/Musical shows/7.jpg" width ="100%" , alt="fashion show" ></td></center>
		<td><center><img src ="images/Musical shows/8.jpg" width ="100%" , alt="music feast" ></td></center>
		<td><center><img src ="images/Musical shows/9.jpg" width ="80%" , alt="religious event" ><br><br></td></center>
	</tr></div></table></div>
