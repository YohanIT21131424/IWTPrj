<html>
	...
	<div style ='margin: 20px 50px 100px 50px;'>
		...
		<center> <h1>Religious Events</h1></center><br>
	<p class = 'p'>Religious pictures play a part in the liturgical and devotional 
	lives of followers of specific religious faiths, according to religious doctrine. 
	In religious history, the usage of sacred imagery has been a difficult matter. 
	The diverse traditions of aniconism in religions are motivated by a fear of idolatry.</p><br>
	
		<table width = "100%">
	<tr>
		<td><center><img src ="images/Religious events/1.jpg" width ="80%" , alt="william bday" ></td></center>
		<td><center><img src ="images/Religious events/2.jpg" width ="80%" , alt="adam and eve wedding" ></td></center>
		<td><center><img src ="images/Religious events/3.jpg" width ="80%" , alt="graduation" ></td></center>
	</tr>
	<tr>
		<td><center><img src ="images/Religious events/4.jpg" width ="80%" , alt="fashion show" ></td></center>
		<td><center><img src ="images/Religious events/5.jpg" width ="80%" , alt="music feast" ></td></center>
		<td><center><img src ="images/Religious events/6.jpg" width ="80%" , alt="religious event" ></td></center>
	</tr>
	<tr>
		<td><center><img src ="images/Religious events/7.jpg" width ="80%" , alt="fashion show" ></td></center>
		<td><center><img src ="images/Religious events/8.jpg" width ="80%" , alt="music feast" ><br><br></td></center>
		<td><center><img src ="images/Religious events/9.jpg" width ="80%" , alt="religious event" ></td></center>
	</tr></div></table></div>
