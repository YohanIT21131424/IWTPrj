<html>
	...
	<div style ='margin: 20px 50px 100px 50px;'>
		...
		<center> <h1>Wildlife</h1></center><br>
	<p class = 'p'>Wildlife photography has the ability to arouse people's interest in the 
	natural world. It's a crucial tool for motivating people to care about wildlife and 
	effecting genuine change. In a matter of minutes, photos may go viral on social 
	media, bringing much-needed attention to creatures in peril.</p><br>
	
		<table width = "100%">
	<tr>
		<td><center><img src ="images/Wildlife/1.jpg" width ="80%" , alt="william bday" ></td></center>
		<td><center><img src ="images/Wildlife/2.jpg" width ="80%" , alt="adam and eve wedding" ></td></center>
		<td><center><img src ="images/Wildlife/3.jpg" width ="80%" , alt="graduation" ></td></center>
	</tr>
	<tr>
		<td><center><img src ="images/Wildlife/4.jpg" width ="80%" , alt="fashion show" ></td></center>
		<td><center><img src ="images/Wildlife/5.jpg" width ="80%" , alt="music feast" ></td></center>
		<td><center><img src ="images/Wildlife/6.jpg" width ="80%" , alt="religious event" ></td></center>
	</tr>
	<tr>
		<td><center><img src ="images/Wildlife/7.jpg" width ="80%" , alt="fashion show" ></td></center>
		<td><center><img src ="images/Wildlife/8.jpg" width ="80%" , alt="music feast" ><br><br></td></center>
		<td><center><img src ="images/Wildlife/9.jpg" width ="80%" , alt="religious event" ></td></center>
	</tr></div></table></div>
